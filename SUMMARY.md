...
- [Introduction](basics/introduction/README.md)
  - [WebAssembly](basics/introduction/webassembly.md)
  - [WAMR project](basics/introduction/wamr-project.md)

- [Getting started](basics/getting_started/README.md)
  - [hello world program on host](basics/getting_started/on-host.md)
  - [hello world program on docker](basics/getting_started/on-docker.md)

## WAMR in practice

- [Tutorial](tutorial/README.md)
  - [build tutorial](tutorial/build_tutorial/README.md)
...
- [Programmer's manual](programmer's_manual/README.md)
